...
if __name__ == '__main__':
    ...
    #
    auc, acc, pre, recall, f1, fprs, tprs = Train(directory='data/DrugBank_Approved',#'data/DrugBank_Approved'
    # 'data/Enzyme' 'data/GPCR' 'data/HGBI' 'data/Ion_channels' 'data/Nuclear_receptors' 'data/DITNETDate'
                                                  epochs=5,
                                                  aggregator='APPNPConv',  # 'APPNPConv'
                                                  # 'SAGEConv' 'GraphConv' 'TAGConv' 'GATConv' or others(None)
                                                  embedding_size=256,
                                                  layers=4,
                                                  dropout=0.2,
                                                  slope=0.2,  # LeakyReLU
